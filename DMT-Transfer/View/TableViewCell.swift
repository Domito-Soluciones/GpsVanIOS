...
class TableViewCell: UITableViewCell {
    ...
    var servicio:Servicio? {
        didSet {
            ...
            if(estado == "1"){
                estadoImageView.image = UIImage(named: "oknaranjo")
                idLabel.textColor = .orange
            }
            else if(estado == "3"){
                estadoImageView.image = UIImage(named: "okverde")
                idLabel.textColor = .green
            }
            else if(estado == "4"){
                estadoImageView.image = UIImage(named: "okazul")
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        fechaLabel.leadingAnchor.constraint(equalTo:self.idLabel.trailingAnchor, constant:10).isActive = true
    }
